...
import { get, has, insert, remove, set, renumberKeys } from './keypath';
...
describe('keypath util', () => {
  ...
  describe('insert()', () => {
    ...
    it('should insert into a nested array', () => {
      ...
      expect((object.a as Record<'b', string[]>).b).toEqual(['x', 'y', 'z']);
    });
  ...
  describe('set()', () => {
    ...
    it('should created nested objects by string key parts', () => {
      ...
      expect((object.a as Record<'b', Record<'c', string>>).b.c).toEqual(value);
    });
    ...
    it('should created nested objects by string key parts when keys passed as an array', () => {
      ...
      expect((object.a as Record<string, Record<string, string>>).b.c).toEqual(value);
    });
    ...
    it('should insert value into array for numeric key parts', () => {
      ...
      expect((object.a as unknown[])[0]).toEqual(value);
    });
    ...
    it('should create an object inside an array', () => {
      ...
      expect((object.a as Array<Record<string, string>>)[0].b).toEqual(value);
    });
  });
  ...
  describe('remove()', () => {
    ...
    it('should remove a nested property from an object', () => {
      ...
      expect((object.a as Record<string, Record<string, string>>).b).not.toHaveProperty('c');
    });
