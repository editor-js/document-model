import type { ToolFormattingOptions, InlineTool, InlineToolConstructor, TextRange, InlineFragment } from '@editorjs/sdk';
...
ItalicInlineTool satisfies InlineToolConstructor;
