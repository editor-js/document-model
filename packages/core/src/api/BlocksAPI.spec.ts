...
describe('BlocksAPI', () => {
  ...
  it('delete should pass explicit index to blocksManager.deleteBlock', () => {
    const api = new BlocksAPI(blocksManager, { defaultBlock } as CoreConfigValidated);
  ...
  it('delete should pass undefined when index is omitted', () => {
    const api = new BlocksAPI(blocksManager, { defaultBlock } as CoreConfigValidated);
  ...
  it('insert should use defaults and pass payload to blocksManager.insert', () => {
    const api = new BlocksAPI(blocksManager, { defaultBlock } as CoreConfigValidated);
  ...
  it('insert should pass provided params to blocksManager.insert and ignore compatibility args', () => {
    const api = new BlocksAPI(blocksManager, { defaultBlock } as CoreConfigValidated);
